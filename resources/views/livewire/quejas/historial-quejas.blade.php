<div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-2">
        <h6 class="mb-0 text-muted">
            <i class="fas fa-history mr-1"></i>Historial de Quejas y Sugerencias
        </h6>
        ...
        @forelse ($quejas as $item)
            <div class="card mb-2 shadow-sm">
                <div class="card-body py-2 px-3">
                    ...
                    {{-- Fila 3: revisor·coordinador + fecha + acción --}}
                    <div class="d-flex justify-content-between align-items-center">
                        <div style="font-size:0.75rem;color:#888;">
                            @if ($item->revisor)
                                <i class="fas fa-user-check mr-1"></i>{{ $item->revisor->name }}
                            @else
                                <span class="text-muted">Sin revisor</span>
                            @endif
                            @if ($item->coordinador)
                                <span class="ml-1">· {{ $item->coordinador->name }}</span>
                            @endif
                        </div>
    ...
    <div class="card card-outline card-primary d-none d-md-block">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-history mr-2"></i>Historial de Quejas y Sugerencias
            </h3>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body p-2 p-md-3">
                        ...
                        <div class="row mb-3" style="font-size:0.85rem;">
                            ...
                            <div class="col-6 mb-2">
                                <small class="text-muted d-block">Derivado a</small>
